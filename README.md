...
4.5: if you have something running on your 80th port feel free to change the docker-compose to your liking/n
5:open a web broweser and open "https://localhost:80/home"/n

the project is in the form/n
webbapp/n
       |
       |
       |__pages(frontend)/n
